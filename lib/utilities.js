...
var Error = function(details) {
    ...
    this.error = details.error || details.err || null;
...
Error.prototype.toString = function() {
    return _.compact(['Error', this.action,
        (this.error) ? ':' : null,
        this.error,
        (this.message) ? '>' : null,
        this.message
...
Error.prototype.throw = function(details) {
    if (typeof details === 'string') details = { error: details };
    if (details instanceof Error) details = details.get();
    details = details || {};
    ...
    details = _.extend(this.get(), details);

    return new exports.Error(details);
};
